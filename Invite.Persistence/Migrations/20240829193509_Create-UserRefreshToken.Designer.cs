...
namespace Invite.Persistence.Migrations
{
    ...
    [Migration("20240829193509_Create-UserRefreshToken")]
    partial class CreateUserRefreshToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Invite.Entities.Models.BuffetModel", b =>
                {
                    ...
                    b.Property<string>("ServeInRadius")
                        .IsRequired()
                        .HasMaxLength(4)
            ...
            modelBuilder.Entity("Invite.Entities.Models.CerimonialistModel", b =>
                {
                    ...
                    b.ToTable("Cerimonialists");
                });

            modelBuilder.Entity("Invite.Entities.Models.CodeModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Invite.Entities.Models.CommentModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("CerimonialistId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Invite.Entities.Models.InvoiceItemizedModel", b =>
                {
                    ...
                    b.Property<Guid?>("CerimonialisId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Invite.Entities.Models.LeadModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Invite.Entities.Models.CommentModel", b =>
                {
                    ...
                    b.HasOne("Invite.Entities.Models.CerimonialistModel", "Cerimonialist")
                        .WithMany()
                        .HasForeignKey("CerimonialistId");
